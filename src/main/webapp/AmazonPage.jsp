                ...
                <div class="productCardContainer col-lg-3">
                    <div class="productCard">
                        ...
                        <a href="<%= request.getContextPath() %>/product?session=0&product_id=${product.getProduct_id()}">
                            <img src="${products.get("ads")[i].get("image") }" alt="" class="productImage">
                            <h5 class="productName">${products.get("ads")[i].get("name") }</h5>
                        </a>
                        <i class="far fa-heart"></i>
                        <span class="productPrice">${products.get("ads")[i].get("price_string") }</span>

...
<body>
            ...
            <div class="row">
                ...
                <div class="productCardContainer col-lg-3">
                    <div class="productCard">
                        ...
                        <a href="<%= request.getContextPath() %>/product?session=1&product_id=${product.getProduct_id()}&user_id=${user.getUser_id()}">
    ...
    <footer class="shoppinCartFooter" style="position: relatif">
        ...
        <div class="verticalLine"></div>
        <img src="images/ensiasLogo.png" alt="" class="ensiasLogo">
    </footer>
